...
BEGIN
  ...
  VALUES
    ...
    (season_id, 4, 'Miami Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Miami International Autodrome'), '2026-05-03 20:00:00+00', '2026-05-02 20:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 5, 'Canadian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit Gilles Villeneuve'), '2026-05-24 20:00:00+00', '2026-05-23 20:00:00+00', 1, false, NOW(), NOW(), NULL),
    ...
    (season_id, 9, 'British Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Silverstone Circuit'), '2026-07-05 14:00:00+00', '2026-07-04 15:00:00+00', 1, false, NOW(), NOW(), NULL),
    ...
    (season_id, 12, 'Dutch Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit Zandvoort'), '2026-08-23 13:00:00+00', '2026-08-22 14:00:00+00', 1, false, NOW(), NOW(), NULL),
    ...
    (season_id, 16, 'Singapore Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Marina Bay Street Circuit'), '2026-10-11 12:00:00+00', '2026-10-10 13:00:00+00', 1, false, NOW(), NOW(), NULL),
