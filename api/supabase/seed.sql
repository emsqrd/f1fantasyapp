...
BEGIN
  ...
  -- Insert SeasonConstructors for 2026 (11 teams)
  ...
  -- Insert circuits (skip any whose name already exists)
  INSERT INTO "Circuits"
    ("Name", "Location", "Country", "IsDeleted", "CreatedAt", "UpdatedAt", "DeletedAt")
  SELECT v."Name", v."Location", v."Country", false, NOW(), NOW(), NULL
  FROM (VALUES
    ...
    ('Madrid Street Circuit', 'Madrid', 'Spain'),
  ...
  ) AS v("Name", "Location", "Country")
  WHERE NOT EXISTS (SELECT 1 FROM "Circuits" c WHERE c."Name" = v."Name");
