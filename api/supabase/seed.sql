...
BEGIN
  ...
  VALUES
    ...
    (season_id, 2, 'Chinese Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Shanghai International Circuit'), '2026-03-15 07:00:00+00', '2026-03-14 03:00:00+00', 1, false, NOW(), NOW(), NULL),
    ...
    (season_id, 4, 'Miami Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Miami International Autodrome'), '2026-05-03 20:00:00+00', '2026-05-02 16:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 5, 'Canadian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit Gilles Villeneuve'), '2026-05-24 20:00:00+00', '2026-05-23 16:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 6, 'Monaco Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit de Monaco'), '2026-06-07 13:00:00+00', '2026-06-06 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 7, 'Spanish Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit de Barcelona-Catalunya'), '2026-06-14 13:00:00+00', '2026-06-13 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 8, 'Austrian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Red Bull Ring'), '2026-06-28 13:00:00+00', '2026-06-27 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 9, 'British Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Silverstone Circuit'), '2026-07-05 14:00:00+00', '2026-07-04 11:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 10, 'Belgian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit de Spa-Francorchamps'), '2026-07-19 13:00:00+00', '2026-07-18 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 11, 'Hungarian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Hungaroring'), '2026-07-26 13:00:00+00', '2026-07-25 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 12, 'Dutch Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit Zandvoort'), '2026-08-23 13:00:00+00', '2026-08-22 10:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 13, 'Italian Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Autodromo Nazionale di Monza'), '2026-09-06 13:00:00+00', '2026-09-05 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 14, 'Madrid Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Madrid Street Circuit'), '2026-09-13 13:00:00+00', '2026-09-12 14:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 15, 'Azerbaijan Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Baku City Circuit'), '2026-09-26 11:00:00+00', '2026-09-25 12:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 16, 'Singapore Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Marina Bay Street Circuit'), '2026-10-11 12:00:00+00', '2026-10-10 09:00:00+00', 1, false, NOW(), NOW(), NULL),
    (season_id, 17, 'United States Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Circuit of the Americas'), '2026-10-25 20:00:00+00', '2026-10-24 21:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 18, 'Mexico City Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Autódromo Hermanos Rodríguez'), '2026-11-01 20:00:00+00', '2026-10-31 21:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 19, 'São Paulo Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Autódromo José Carlos Pace'), '2026-11-08 17:00:00+00', '2026-11-07 18:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 20, 'Las Vegas Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Las Vegas Street Circuit'), '2026-11-22 04:00:00+00', '2026-11-21 04:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 21, 'Qatar Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Lusail International Circuit'), '2026-11-29 16:00:00+00', '2026-11-28 18:00:00+00', 0, false, NOW(), NOW(), NULL),
    (season_id, 22, 'Abu Dhabi Grand Prix', (SELECT "Id" FROM "Circuits" WHERE "Name" = 'Yas Marina Circuit'), '2026-12-06 13:00:00+00', '2026-12-05 14:00:00+00', 0, false, NOW(), NOW(), NULL)
