...
namespace F1CompanionApi.Data.Migrations
{
    ...
    [Migration("20260411180047_RenameRaceToSeasonRace")]
    partial class RenameRaceToSeasonRace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.Circuit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.ConstructorRaceScore", b =>
                {
                    ...
                    b.Property<int?>("SprintFastestLapPoints")
                        .HasColumnType("integer");

                    b.Property<int?>("SprintOvertakePoints")
                        .HasColumnType("integer");

                    b.Property<int?>("SprintPenaltyPoints")
                        .HasColumnType("integer");

                    b.Property<int?>("SprintPositionChangePoints")
                        .HasColumnType("integer");

                    b.Property<int?>("SprintPositionPoints")
                        .HasColumnType("integer");

                    b.Property<int?>("SprintTotal")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ConstructorId", "SeasonRaceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.DriverQualifyingResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DriverId", "SeasonRaceId")
                        .IsUnique();

                    b.ToTable("DriverQualifyingResults");
                });

            modelBuilder.Entity("F1CompanionApi.Data.Entities.DriverRaceResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("DriverId", "SeasonRaceId", "SessionType")
                        .IsUnique();
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.LeagueInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.LineupEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TeamId", "SeasonRaceId", "EntityType", "SlotPosition")
                        .IsUnique();

                    b.ToTable("LineupEntries");
                });

            modelBuilder.Entity("F1CompanionApi.Data.Entities.Season", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.SeasonConstructor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SeasonId", "ConstructorId")
                        .IsUnique();

                    b.ToTable("SeasonConstructors");
                });

            modelBuilder.Entity("F1CompanionApi.Data.Entities.SeasonDriver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.SeasonRace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("LockDeadline")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.TeamRaceScore", b =>
                {
                    ...
                    b.HasIndex("TeamId", "SeasonRaceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.ConstructorRaceScore", b =>
                {
                    ...
                    b.HasOne("F1CompanionApi.Data.Entities.SeasonRace", "SeasonRace")
                        .WithMany()
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.SeasonConstructor", b =>
                {
                    ...
                    b.HasOne("F1CompanionApi.Data.Entities.Season", "Season")
            ...
            modelBuilder.Entity("F1CompanionApi.Data.Entities.SeasonRace", b =>
                {
                    b.HasOne("F1CompanionApi.Data.Entities.Circuit", "Circuit")
                        .WithMany()
